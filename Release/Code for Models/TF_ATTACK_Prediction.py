...
# Преобразуем типы меток из столбца 'Label' в числовые значения с помощью LabelEncoder
...
model.add(tf.keras.layers.Dense(2, activation='softmax'))  # Выходной слой с 2 классами (Benign/Attack)
